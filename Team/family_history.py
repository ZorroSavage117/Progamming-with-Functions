...
def print_death_age(people_dict):
    ...
    """
    print("Ages at Death")
    for vin in people_dict:
        person_list = people_dict[vin]
        name = person_list[NAME_INDEX]
        age = person_list[DEATH_YEAR_INDEX] - person_list[BIRTH_YEAR_INDEX]
        print(f"{name} | {age}")
...
def print_marriages(marriages_dict, people_dict):
    ...
    """
    print("Marriages")
    for vin in marriages_dict:
        marriage_lt = marriages_dict[vin]
        year = marriage_lt[WEDDING_YEAR_INDEX]
        hus = marriage_lt[HUSBAND_KEY_INDEX]
        person1_lt = people_dict[hus]
        h_name = person1_lt[NAME_INDEX]
        h_age = year - person1_lt[BIRTH_YEAR_INDEX]
        wif = marriage_lt[WIFE_KEY_INDEX]
        person2_lt = people_dict[wif]
        w_name = person2_lt[NAME_INDEX]
        w_age = year - person2_lt[BIRTH_YEAR_INDEX]
        print(f"{h_name} | {h_age} > {year} < {w_name} | {w_age}")
